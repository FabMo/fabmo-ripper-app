/*
 * Create a rip cut using the provided options:
 * x : The x location of the cut
 * y : The y location of the center cut
 * quads : The quadrant lines to cut
 * w : The overall width of the area
 * h : The overall height of the area
 * thickness : The material thickness being cut
 * cut_through : The amount of extra cut to ensure that we made it through the material
 *
 * Returns a string of the OpenSBP program.
 */
